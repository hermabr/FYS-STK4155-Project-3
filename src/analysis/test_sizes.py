...
def main():
    ...
    for test_size in tqdm(np.arange(0.1, 1, 0.1)):
        ...
        accuracy_texts.append(
            f"{test_size:.1f},{accuracy_logistic*100},{accuracy_pytorch*100},{accuracy_tensorflow*100},{accuracy_ffnn*100}\n"
        )
    ...
    with open("test_size_performance.csv", "w") as f:
        f.write("test_size,logistic,pytorch,tensorflow,ffnn\n")
